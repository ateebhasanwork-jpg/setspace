...
import { Calendar, Plus, Video, Clock, Link as LinkIcon } from "lucide-react";
      ...
      {isLoading ? (
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {meetings?.map(meeting => (
            <Card key={meeting.id} className="glass-panel p-6 flex flex-col justify-between group hover:border-primary/50 transition-colors">
              <div>
